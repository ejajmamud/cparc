    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->schema([
            ...
            Section::make('Contact & Settings')->columns(3)->schema([
                ...
                Forms\Components\FileUpload::make('photo')->image()->disk('public')->directory('members')->imageResizeMode('cover')->imageResizeTargetWidth('600')->imageResizeTargetHeight('800'),
            ]),
        ]);
    }
